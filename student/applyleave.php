...
<head>
    ...
    <?php
        ...
        // $result = mysqli_query($conn, "SELECT count($regno) as total from leaverequests where regno='regno' AND status='Pending';");
    ...
    <?php
        if($_SERVER["REQUEST_METHOD"] == "POST"){
            if( isset($_POST['fromdate']) && isset($_POST['todate']) && isset($_POST['reason']) ){
                ...
                // $month2<$month1 || $day2<$day1 || $day1<$pday || $day2<$pday || $month1<$pmonth || $month2<$pmonth
                if($month2<$month1 || $day2<$day1 || $day1<$pday || $day2<$pday || $month1<$pmonth || $month2<$pmonth){
                    $errmsg = "*Invalid dates: You entered wrong information";
                }
                else{
                    if($count>=1){
